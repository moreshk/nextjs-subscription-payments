      ...
      <div className="dark:bg-gray-900">
        <div className="px-12 py-8">
          <table className="w-full table-auto border-collapse">
            <thead>
              <tr>
                <th className="w-[80px] border border-gray-300 px-6 py-3">
                  No.
                </th>
                <th className="w-[100px] border border-gray-300 px-6 py-3">
                  Chatbot ID
                </th>
            ...
            <tbody>
              {chatbots.map((chatbot, index) => (
                <tr key={chatbot.id}>
                  ...
                  <td className="font-medium border border-gray-300 px-6 py-3">
                    {chatbot.id}
                  </td>
                  <td className="border border-gray-300 px-6 py-3">
                    {chatbot.prompt}
